...
export default function Bedroom() {
  const products = [
    { id: 1, name: "Platform Bed", price: "$2,400", image: "/api/placeholder/300/300", category: "Beds" },
    { id: 2, name: "Nightstand", price: "$650", image: "/api/placeholder/300/300", category: "Storage" },
    { id: 3, name: "Dresser", price: "$1,800", image: "/api/placeholder/300/300", category: "Storage" },
    { id: 4, name: "Wardrobe", price: "$2,800", image: "/api/placeholder/300/300", category: "Storage" },
    { id: 5, name: "Reading Chair", price: "$1,200", image: "/api/placeholder/300/300", category: "Seating" },
    { id: 6, name: "Mirror", price: "$450", image: "/api/placeholder/300/300", category: "Decor" }
  ];
