...
export default function Outdoor() {
  ...
  const products = [
    { id: 1, name: "STRATA TEAK OUTDOOR DINING SET", memberPrice: "$1760", regularPrice: "$2,200", image: productImages[1], category: "Dining", colors: ["#8B4513", "#A0522D"] },
    { id: 2, name: "STRATA TEAK LOUNGE CHAIR", memberPrice: "$680", regularPrice: "$850", image: productImages[0], category: "Seating", colors: ["#D2691E", "#DEB887"] },
    { id: 3, name: "STRATA TEAK GARDEN BENCH", memberPrice: "$520", regularPrice: "$650", image: productImages[2], category: "Seating", colors: ["#8B4513", "#CD853F"] },
    { id: 4, name: "STRATA TEAK OUTDOOR SOFA", memberPrice: "$1440", regularPrice: "$1,800", image: productImages[1], category: "Seating", colors: ["#A0522D", "#D2691E"] },
    { id: 5, name: "STRATA TEAK SIDE TABLE", memberPrice: "$256", regularPrice: "$320", image: productImages[0], category: "Tables", colors: ["#8B4513", "#DEB887"] },
    { id: 6, name: "STRATA TEAK UMBRELLA STAND", memberPrice: "$144", regularPrice: "$180", image: productImages[2], category: "Accessories", colors: ["#CD853F", "#A0522D"] }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/outdoor" className="text-sm font-medium text-primary border-b-2 border-primary" data-testid="nav-outdoor">
                Outdoor
              </Link>
            </div>
