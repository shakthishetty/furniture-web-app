...
export default function New() {
  const products = [
    ...
    { id: 2, name: "Minimalist Desk", price: "$1,200", image: "/api/placeholder/300/300", category: "Study" },
    { id: 3, name: "Comfort Lounge Chair", price: "$2,800", image: "/api/placeholder/300/300", category: "Living Room" },
    { id: 4, name: "Platform Bed Frame", price: "$1,800", image: "/api/placeholder/300/300", category: "Bedroom" },
    { id: 5, name: "Outdoor Bench", price: "$650", image: "/api/placeholder/300/300", category: "Outdoor" },
    { id: 6, name: "Coffee Table", price: "$850", image: "/api/placeholder/300/300", category: "Living Room" }
  ];
