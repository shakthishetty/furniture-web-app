...
export default function Dining() {
  ...
  const products = [
    { id: 1, name: "Dining Table", price: "$2,800", image: productImages[1], category: "Tables" },
    { id: 2, name: "Dining Chair Set", price: "$1,200", image: productImages[0], category: "Seating" },
    { id: 3, name: "Sideboard", price: "$1,800", image: productImages[2], category: "Storage" },
    { id: 4, name: "Bar Stool", price: "$450", image: productImages[1], category: "Seating" },
    { id: 5, name: "China Cabinet", price: "$2,200", image: productImages[0], category: "Storage" },
    { id: 6, name: "Bench", price: "$650", image: productImages[2], category: "Seating" }
  ];
