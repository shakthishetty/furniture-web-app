...
export default function Dining() {
  ...
  const products = [
    { id: 1, name: "STRATA TEAK DINING TABLE", memberPrice: "$2240", regularPrice: "$2,800", image: productImages[1], category: "Tables", colors: ["#8B4513", "#A0522D"] },
    { id: 2, name: "STRATA TEAK DINING CHAIR SET", memberPrice: "$960", regularPrice: "$1,200", image: productImages[0], category: "Seating", colors: ["#D2691E", "#DEB887"] },
    { id: 3, name: "STRATA TEAK SIDEBOARD", memberPrice: "$1440", regularPrice: "$1,800", image: productImages[2], category: "Storage", colors: ["#8B4513", "#CD853F"] },
    { id: 4, name: "STRATA TEAK BAR STOOL", memberPrice: "$360", regularPrice: "$450", image: productImages[1], category: "Seating", colors: ["#A0522D", "#D2691E"] },
    { id: 5, name: "STRATA TEAK CHINA CABINET", memberPrice: "$1760", regularPrice: "$2,200", image: productImages[0], category: "Storage", colors: ["#8B4513", "#DEB887"] },
    { id: 6, name: "STRATA TEAK BENCH", memberPrice: "$520", regularPrice: "$650", image: productImages[2], category: "Seating", colors: ["#CD853F", "#A0522D"] }
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/dining" className="text-sm font-medium text-primary border-b-2 border-primary" data-testid="nav-dining">
                Dining
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* Page Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold font-serif mb-4" data-testid="page-title">Dining Room</h1>
          <p className="text-muted-foreground text-lg" data-testid="page-description">
            Transform your dining space into a place where meals become memories with our elegant dining collection.
          </p>
        </div>
